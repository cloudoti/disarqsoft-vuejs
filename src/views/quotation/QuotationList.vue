<template>
  <div class="mx-auto lg:max-w-7xl">
    <div class="bg-white px-4 shadow p-6 sm:rounded-lg">
      <BreadCrumb :show-back="false">Cotizaciones</BreadCrumb>
      <section
          aria-labelledby="who-to-follow-heading">
        <div class="flex items-end justify-end mt-2">
          <router-link
              :to="{name: ERouteType.NEW_QUOTATION_NAME}"
        ...
        <div class="mt-5">
          <Input
              ...
              v-model.lazy="search"
              :hide-optional="true"
              v-on:change="getPagedQuotations()"
              :debounce="500"
          >
            <template #leftIcon>
...
const pagination = ref<Quotation[]>();
...
const getPagedQuotations = (selectedPage?: number, rowsPerPage?: number) => {
